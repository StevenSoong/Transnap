...
3. 在“通用”页面授予辅助功能权限：可以点击“打开设置…”，也可以把页面中的闪译图标直接拖到系统设置的“辅助功能”列表，再打开右侧开关。
...
如果系统设置中尚未出现闪译，可以打开“闪译设置 → 通用”，把其中的应用图标拖到系统设置的“隐私与安全性 → 辅助功能”列表，再打开闪译旁边的开关。建议先将 `Transnap.app` 移到 `/Applications`，再完成授权。
